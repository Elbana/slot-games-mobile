/**
 * JSON spin API — Stadium of Riches
 */
import { spinFootballGold } from './games/stadium-of-riches/spin.mjs';
import { effectiveBet } from './games/stadium-of-riches/freespin.mjs';
