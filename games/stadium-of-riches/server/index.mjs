/**
 * Stadium of Riches — dev + production server (Pixi client + JSON spin API).
 */
...
app.get('/health', (_req, res) => {
  res.json({ ok: true, game: 'stadium-of-riches', env: IS_PRODUCTION ? 'production' : 'development' });
});
...
server.listen(PORT, () => {
  console.log(`Stadium of Riches (PixiJS) — http://localhost:${PORT}/`);
