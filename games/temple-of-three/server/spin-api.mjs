/**
 * JSON spin API — Temple of Three
 */
import { spinEgyptTreasures } from './games/temple-of-three/spin.mjs';
...
export function handleV2Spin(req, res) {
  ...
  const result = spinEgyptTreasures(session, bet, { spinId: spinId ?? Date.now() });
