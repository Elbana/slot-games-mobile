/**
 * Rise of Olympus — dev + production server (Pixi client + JSON spin API).
 */
...
app.get('/health', (_req, res) => {
  res.json({ ok: true, game: 'rise-of-olympus', env: IS_PRODUCTION ? 'production' : 'development' });
});
...
server.listen(PORT, () => {
  console.log(`Rise of Olympus (PixiJS) — http://localhost:${PORT}/`);
